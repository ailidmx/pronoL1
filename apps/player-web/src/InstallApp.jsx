...
export default function InstallApp() {
  ...
  return <aside className="pwa-install-banner" aria-label="Installer Prono L1">
    <div><strong>Installer Prono L1</strong><span>{ios ? "Safari : Partager → Sur l’écran d’accueil" : prompt ? "Ajoute l’application Prono L1 à ton appareil." : "Utilise le menu du navigateur puis « Installer l’application »."}</span></div>
