...
export const paths = {
  ...
  competition: (competitionId) => `${collections.competitions}/${competitionId}`,
  competitionSeason: (competitionSeasonId) => `${collections.competitionSeasons}/${competitionSeasonId}`,
